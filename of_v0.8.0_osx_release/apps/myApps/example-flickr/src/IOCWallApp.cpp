...
//void IOCWallApp::loadImages(std::vector<std::string> imgUrlVector)
//{
//    for(int i = 0; i < imgUrlVector.size(); i++)
//    {
//        ofImage img;
...
void IOCWallApp::mousePressed(int x, int y, int button){
	tileLayer.updateImages(2,true);
    cout << "mousePressed: " << x << ", " << y << " button: " << button << endl;
}

//void IOCWallApp::finishedLoadingURLs(std::vector<std::string> imgUrlVector)
//{
